/*
** gui_put.c for zappy in /home/kokaz/projects/tek2/unix/zappy/server
**
** Made by guillaume fillon
** Login   <kokaz@epitech.net>
**
** Started on  Fri Jul  4 14:46:39 2014 guillaume fillon
** Last update Mon Jul  7 11:20:24 2014 guillaume fillon
*/
...
int		gui_put(t_server *server, t_client *graphic,
			 t_client *client, t_gui_arg *arg)
{
  ...
  queue_push_message(&graphic->queue, "pdr %d %d\n", pl->id, arg->id);
